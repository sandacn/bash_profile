#export PS1="\[\e]0;\u@\h: \w\a\]\[\033[01;31m\][\A]\[\033[01;32m\]\u\[\033[00m\]@\[\033[01;35m\]\h:\[\033[01;34m\]\w\[\033[00m\]\$"
...
exec /usr/bin/script -a -f -q /var/bash/`last|head -1|awk '{print $1"-from-"$3"-at-"}'``date +%Y%m%d%k%M`.lst
